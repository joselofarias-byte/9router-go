...
func ForwardWorkBuddySession(w http.ResponseWriter, req *Request) error {
	...
	if err := cmd.Run(); err != nil {
		...
		if workBuddyLooksLikeExpiredSession(msg) {
			return fmt.Errorf("workbuddy-session CLI: session expired: %w: %s", err, msg)
		}
...
func workBuddyLooksLikeExpiredSession(msg string) bool {
