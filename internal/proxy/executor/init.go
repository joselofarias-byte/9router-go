...
func RegisterAll() {
	...
	Register("workbuddy-session", func() Executor { return ForwardWorkBuddySession })
	Register("orcarouter", func() Executor { return ForwardOpenAI })
	Register("unorouter", func() Executor { return ForwardOpenAI })
